    ...
    <div class="row justify-center q-pa-md">
      <div class="col-md-9 col-12">
        <div class="row q-col-gutter-md">
          <!-- left item details -->
          <div id="menu" class="col-md-4 col-sm-4 col-xs-12">
            <ProductSkeletonLeft v-if="loading" />

            <template v-else>
              <div class="float-right q-mb-xs">
                <Favs
                  ref="favs"
              ...
              <h5 class="text-weight-bold q-pt-sm q-pb-sm" v-html="items.item_name"></h5>
              <div
                class="font12 text-weight-thin ellipsis-3-lines q-mb-sm"
                style="max-height: 56px"
                v-html="items.item_description"
              ></div>

              <div class="q-gutter-x-xs q-mb-md" v-if="meta.dish">
                <template v-for="dish_id in meta.dish" :key="dish_id">
              ...
              <!-- quantity -->
              <div v-if="$q.screen.gt.sm" class="row items-center justify-center">
              ...
              <div v-if="$q.screen.gt.sm" class="q-mt-md q-mb-md">
          ...
          <div class="col-md-8 col-sm-8 col-xs-12">
            <q-card flat class="fit">
              <q-card-section>
                ...
                <template v-else>
                  <h5 class="text-weight-bold">{{ $t("Customize your Order") }}</h5>
                  <q-option-group
                    ...
                    >
                      ...
                      <div class="row justify-between bg-grey-1 q-pa-sm">
                        ...
                        >
                          ...
                          <template v-else>
                            {{
                              $t("Choose up to {count}", {
                                count: addons.multi_option_value,
                              })
                            }}
                          </template>
                        </p>
        ...
        <SimilarItems
          class="q-mt-lg"
          ref="similar_items"
          :title="$t('More similar items')"
          bg="bg-mygrey"
          :change_currency="transactionStore.change_currency"
        />
        <!-- more items -->
      </div>
      <!-- col -->
...
export default {
  ...
  setup() {
    ...
    return { SettingsStore, schedStore, transactionStore, DataStorePersisted };
  },
  data() {
    return {
      // router: useRouter(),
